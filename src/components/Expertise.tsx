    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 mb-1.5 min-w-0">
        ...
        <div className="flex items-center gap-2 shrink-0">
          {skill.proof && (
            <a href={skill.proof.href} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 px-2 py-1 rounded-md bg-emerald-500/15 border border-emerald-500/30 hover:bg-emerald-500/25 transition-all max-w-[60px] sm:max-w-none">
